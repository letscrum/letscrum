...
func InitRouter() *gin.Engine {
	...
	apisV1.Use(jwtMiddleware.JWT())
	{
		...
		apisV1.POST("projects/:project_id/sprints/:sprint_id", v1.CreateSprintMember)
	}
